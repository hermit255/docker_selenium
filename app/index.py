...
from modules.sites.ShowGoogleHtml import ShowGoogleHtml
from modules.sites.ShowMitsuiOld import ShowMitsuiOld
from modules.sites.ShowMitsuiNew import ShowMitsuiNew
...
app.add_url_rule('/google', view_func=ShowGoogleHtml)
app.add_url_rule('/mitsuio', view_func=ShowMitsuiOld)
app.add_url_rule('/mitsuin', view_func=ShowMitsuiNew)
